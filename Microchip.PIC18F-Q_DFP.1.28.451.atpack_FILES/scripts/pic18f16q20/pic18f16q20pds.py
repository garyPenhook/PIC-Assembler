...
class DeviceDefinition(PicDevice):
    ...
    # Only the config byte addresses in this list are allowed to be written (i.e. blocking access to SAFLOCK related config bytes)
    CONFIG_BYTES_WRITABLE = [
        0x300000, 0x300001, 0x300002, 0x300003, 0x300004, 0x300005, 0x300006, 0x300007, 0x300008, 0x300009, 0x30000A
    ]
